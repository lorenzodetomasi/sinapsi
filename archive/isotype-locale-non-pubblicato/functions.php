...
// Stylesheets
// 1. AboveTheFold
$GLOBALS['ws_styles']['head']['all'] = array(
  'media' => false,
  'path' => array('css/all-abovethefold.css')
);
$GLOBALS['ws_styles']['head']['screen'] = array(
  'media' => '@media screen',
  'path' => array('css/screen-abovethefold.css')
);
$GLOBALS['ws_styles']['head']['vgrid'] = array(
  'media' => '@media screen and (max-width: 999px)',
  'path' => array('css/vgrid-abovethefold.css')
);
$GLOBALS['ws_styles']['head']['hgrid'] = array(
  'media' => '@media screen and (min-width: 1000px)',
  'path' => array('css/hgrid-abovethefold.css')
);
$GLOBALS['ws_styles']['head']['maxgrid'] = array(
...
ws_globals_set(array('ws_links'), array(
	...
	'<link rel="stylesheet" type="text/css" media="screen and (min-width: 1280px)" href="'.$ws_theme_url.'css/maxgrid.css" />'
));
// Translations
// # To be completed
$lang = 'en';
