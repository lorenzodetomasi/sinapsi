<?php
// The Business Order at home template file
// @package WS
// @subpackage Localbiz
// @since WS 1.0
...
?>
	<form action="<?php echo ws_href('impresa-contattata').'?to='.urlencode($to_business['id']).'&amp;parent='.urlencode($ws_query['wspath']); ?>" method="POST" name="business-order-form">
<?php
include_template('template-parts/contact-form-header');
include_template('template-parts/order-home-form');
