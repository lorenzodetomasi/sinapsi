...
if((int)$currentYear > (int)$copyrightYear){
	$copyrightInfo = sprintf(__('<abbr title="Copyright">© %1$s - %2$s</abbr> %3$s'), $copyrightYear, $currentYear, $legalName);
} else {
	$copyrightInfo = sprintf(__('<abbr title="Copyright">© %1$s</abbr> %2$s'), $copyrightYear, $legalName);
}
