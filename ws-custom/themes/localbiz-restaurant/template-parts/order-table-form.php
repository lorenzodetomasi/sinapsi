...
<p>
	<a href="" class="button">
		<span class="text"><?php _e('Book your table now'); ?></span>
...
<p class="question">
	<label class="field postal-address flex">
		<span class="label">
			<span class="label-text"><?php _e('When you think you pick up your order?'); ?></span><br />
			<small><?php _e('Enter date and time'); ?></small>
		</span>
		<input name="when-pickup" type="text" class="flex1" placeholder="<?php printf(__('E.g. %s'), __('Tomorrow at 12:00 am')); ?>" />
	</label>
</p>
