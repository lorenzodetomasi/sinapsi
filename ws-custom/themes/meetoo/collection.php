...
/* UN PERCORSO non passa più di qui. Il lungomare - e qualunque raccolta che si
 * guardi come una linea - ha un template suo, `trip.php`, e ci arriva perché lo
 * DICHIARA (`additionalType: "TouristTrip"`), non perché questa pagina lo
 * indovinava dalla distanza delle fermate. Questo file torna a essere quello
 * che dice la sua prima riga: un elenco curato. */
