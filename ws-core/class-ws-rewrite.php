...
class WP_Rewrite {
	 ...
	 * @since 2.5.0
	 *
	 * @global ws_mysql $ws_mysql WordPress database abstraction object.
	 *
	...
	public function page_uri_index() {
		...
		$pages = $ws_mysql->get_results("SELECT ID, post_name, post_parent FROM $ws_mysql->posts WHERE post_type = 'page' AND post_status != 'auto-draft'");
		...
		foreach ( $posts as $id => $post ) {
			// URL => page name
			$uri = get_page_uri($id);
			$attachments = $ws_mysql->get_results( $ws_mysql->prepare( "SELECT ID, post_name, post_parent FROM $ws_mysql->posts WHERE post_type = 'attachment' AND post_parent = %d", $id ));
