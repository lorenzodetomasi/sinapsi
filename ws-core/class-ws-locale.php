...
class WS_Locale {
	...
	// @see WS_Locale::init() for how to handle the hack.
	// @since 0.0.1
	// @var array
	...
	// Stores the translated strings for 'am' and 'pm'. Also the capitalized versions.
	// @since 0.0.1
	// @var array
	public $meridiem;

	// The text direction of the locale language. Default is left to right 'ltr'.
	// @since 0.0.1
	// @var string
	 ...
	 * on ws-admin/options-general.php to the general POT that would
